      ...
      <div className="container">
        ...
        <div className="about">
          ...
          <div className="article_about">
            ...
            <p>
              6000 people from all ages and from all around the globe are gathered
              in the first tourist spaceship hotel that is hosting an inauguration
              party to celebrate the company’s first humans sent to explore
              unknown space. Such a team of explorers consists of several
              scientists and some volunteers, including death row convicts.<br /><br />The
              spaceship encounters an unexpected danger that sends everyone to an
              unknown planet called Hermes. The chaos of the accident along with
              General Relativity results in people landing and waking up at
              incredibly different timeframes. Lanry, an ex-convict and addict,
              lands on Hermes almost 100 years after the first third of passengers
              only to discover that they are on their way of repeating the
              mistakes made in XX and XXI century Earth.
            </p>
            <br></br>
            ...
            <p>
              ...
              writing for the video game industry.<br></br>
              ...
              some really dark aspects of my own family that inevitably motivated me to dive deep into both psychology and art.<br></br>
              ...
              resentment, arrogance and reductionist deceit… The problem was, not even finding what kind of content to create, we
              already had that figured out, the problem was finding a big enough investment to help the project lift off… But for the
              last 2 to 3 years tech has become even more affordable and, surprisingly, I found out there were lots of professionals
              interested in getting involved in such a challenging task. We are over 100 people working on the project already:)
            </p>
          </div>

          <div className="location_icon">
            <img src={location_img} alt="Location" width="64px" height="64px" />
          </div>
